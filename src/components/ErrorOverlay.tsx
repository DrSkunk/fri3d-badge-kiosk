      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
        <DialogPanel className="max-w-lg space-y-4 border-2 border-black rounded-2xl shadow-sticker bg-white text-black p-12">
          ...
          <div className="flex gap-4">
            <button
              className="border-2 border-black rounded-xl px-4 py-2 font-display font-bold bg-white shadow-sticker-sm transition hover:bg-gray-100 active:translate-x-1 active:translate-y-1 active:shadow-none"
              onClick={close}
            >
